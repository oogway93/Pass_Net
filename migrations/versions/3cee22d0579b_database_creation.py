...
Revision ID: 3cee22d0579b
Revises: 
Create Date: 2023-08-14 14:39:22.177315
...
def downgrade() -> None:
    ...
    sa.ForeignKeyConstraint(['post_id'], ['main_post.id'], name='main_comments_post_id_341fa7cd_fk_main_post_id', initially='DEFERRED', deferrable=True),
    ...
    sa.ForeignKeyConstraint(['brand_id'], ['Brand.id'], name='Product_brand_id_bb588269_fk_Brand_id', initially='DEFERRED', deferrable=True),
    ...
    sa.ForeignKeyConstraint(['manufacturer_id'], ['Manufacturer.id'], name='Laptop_manufacturer_id_fd7cb51e_fk_Manufacturer_id', initially='DEFERRED', deferrable=True),
    ...
    sa.Column('permission_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['permission_id'], ['auth_permission.id'], name='User_user_permission_permission_id_8e998ba4_fk_auth_perm', initially='DEFERRED', deferrable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='User_user_permissions_user_id_2c6da4d4_fk_User_id', initially='DEFERRED', deferrable=True),
    sa.PrimaryKeyConstraint('id', name='User_user_permissions_pkey'),
    sa.UniqueConstraint('user_id', 'permission_id', name='User_user_permissions_user_id_permission_id_af0f54ec_uniq')
    )
    op.create_index('User_user_permissions_user_id_2c6da4d4', 'User_user_permissions', ['user_id'], unique=False)
    op.create_index('User_user_permissions_permission_id_8e998ba4', 'User_user_permissions', ['permission_id'], unique=False)
    ...
    sa.Column('basket_history', postgresql.JSONB(astext_type=sa.Text()), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['customer_id'], ['User.id'], name='orders_order_customer_id_0b76f6a4_fk_User_id', initially='DEFERRED', deferrable=True),
    ...
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='django_admin_log_user_id_c564eba6_fk_User_id', initially='DEFERRED', deferrable=True),
    ...
    sa.Column('user_id', sa.BIGINT(), autoincrement=False, nullable=False),
    sa.Column('group_id', sa.INTEGER(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['group_id'], ['auth_group.id'], name='User_groups_group_id_328392a3_fk_auth_group_id', initially='DEFERRED', deferrable=True),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], name='User_groups_user_id_8f675f72_fk_User_id', initially='DEFERRED', deferrable=True),
    ...
    sa.Column('price', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('is_out_of_stocks', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['manufacturer_id'], ['Manufacturer.id'], name='phones_phone_manufacturer_id_72932f6b_fk_phones_manufacturer_id', initially='DEFERRED', deferrable=True),
